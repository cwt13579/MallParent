...
public class Utils {
    ...
    /**
	 * 判断LIST对象不为空 且SIZE大于0
	 * @author chenchao 991722899@qq.com
	 * @date 2014-3-17 下午3:04:44
	 * @param t
	 * @return
	 */
   @SuppressWarnings("rawtypes")
public  static boolean isNotEmpty(List t){
    ...
    public static String fixPersonIDCodeWithCheck(String personIDCode)throws Exception {
		if (Utils.isEmpty(personIDCode) || (personIDCode.trim().length() != 15)) {
