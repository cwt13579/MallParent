...
//        }  
		...
		// 首字母是否大写，默认是小写
		if (isCapital) {
			headChars[0] = Character.toUpperCase(headChar);
		} else {
			headChars[0] = headChar;
		}
    ...
    public static void main(String[] args) {
    	String strs="乐";
    	char[] sChar=strs.toCharArray();
//    	for(char str:sChar){
//    		
//    	}
        System.out.println(PinyinUtil.charArrayToString(getHeadByChar(sChar[0],true)));  
