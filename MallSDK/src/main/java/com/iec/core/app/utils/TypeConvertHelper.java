...
public class TypeConvertHelper {
	...
	if (obj instanceof String) {
		...
		try {
		    ...
		    throw new Exception("Could not convert " + str + " to "
			    + type + ": ", e);
		}
	    }
		...
		throw new Exception("Conversion from " + fromType + " to "
	...
	if ("String".equals(type) || "java.lang.String".equals(type)) {
	    ...
	    throw new Exception("Conversion from " + obj.getClass().getName()
